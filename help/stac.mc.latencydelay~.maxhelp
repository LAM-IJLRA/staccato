...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 614.0, 258.0, 125.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 518.0, 258.0, 90.0, 22.0 ],
					"text" : "loadmess 2048"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 518.0, 282.0, 125.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 621.0, 390.0, 125.0, 22.0 ],
					"text" : "stac.mc.ChainDelay 3"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 668.0, 356.0, 117.0, 24.0 ],
					"presentation_linecount" : 2,
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 50.0, 179.0, 30.0, 22.0 ],
									"text" : "*~ 3"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 207.0, 109.0, 70.0, 22.0 ],
									"text" : "loadmess 1"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 98.0, 107.5, 39.0, 22.0 ],
									"text" : "mtof~"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 98.0, 76.5, 114.0, 22.0 ],
									"text" : "scale~ -1. 1. 70. 90."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 98.0, 48.0, 53.0, 22.0 ],
									"text" : "cycle~ 7"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 154.0, 107.5, 50.0, 22.0 ]
								}
...
,
									"patching_rect" : [ 50.0, 134.5, 123.0, 23.0 ],
									"text" : "gen~ @title bandpass"
								}
...
,
					"patching_rect" : [ 493.0, 357.0, 67.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 592.0, 324.0, 97.0, 22.0 ],
					"text" : "loadmess 12345"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 592.0, 357.0, 79.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 493.0, 390.0, 118.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 493.0, 503.0, 136.0, 30.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 493.0, 474.0, 146.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 366.0, 414.0, 90.0, 22.0 ],
					"text" : "loadmess 2048"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 366.0, 441.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "multichannelsignal", "", "float", "list" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 236.0, 503.0, 136.0, 30.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 236.0, 474.0, 149.0, 22.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-7", 0 ],
					"midpoints" : [ 88.5, 186.0, 245.5, 186.0 ],
					"order" : 1,
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-17" : [ "mc.live.gain~[2]", "mc.live.gain~", 0 ],
