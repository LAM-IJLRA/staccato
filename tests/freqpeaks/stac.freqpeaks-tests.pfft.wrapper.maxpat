...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 280.0, 111.0, 402.0, 22.0 ],
					"text" : "prepend script replace pfft newex 0 0 200 12 pfft~ stac.freqpeaks-tests.pfft"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 45.0, 110.0, 203.0, 22.0 ],
					"text" : "pfft~ stac.freqpeaks-tests.pfft 2048 4",
					"varname" : "pfft"
				}
